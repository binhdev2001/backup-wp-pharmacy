			...
			<div class="ft-card">
			  <h3><i class="fa-regular fa-ban-bug"></i> <?php _e('Debug settings', 'foxtool') ?></h3>
				...
				if (file_exists($debug_log_path)) { ?>
						...
						<div class="ft-pre-me"><a class="delete-debug" href="javascript:void(0)" id="delete-debug"><i class="fa-regular fa-trash"></i> <?php _e('Clear all', 'foxtool'); ?></a></div>
...
function foxtool_debug_options_link() {
	add_submenu_page ('foxtool-options', 'Debug', '<i class="fa-regular fa-gear" style="width:20px;"></i> Debug', 'manage_options', 'foxtool-debug-options', 'foxtool_debug_options_page');
}
