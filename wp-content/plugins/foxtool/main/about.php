...
function foxtool_about_options_link() {
	add_submenu_page ('foxtool-options', 'About', '<i class="fa-regular fa-bomb" style="width:20px;"></i> About', 'manage_options', 'foxtool-about-options', 'foxtool_about_options_page');
}
